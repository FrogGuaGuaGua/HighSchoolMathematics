...
他们的预测能力并支付100元呢？ \\
答案当然是否定的，之所以能保证前面的预测全部正确，是因为诈骗
...
求关于$ t $的方程的判别式。\\
(2) 令$x=\dfrac{At+B}{Dt+E}$，其中$A,B,D,E$为常数且$AE-BD\neq0$，
将原来关于$x$的二次方程转化为关于$t$的二次方程，
求关于$ t $的方程的判别式。\\
\textbf{解}\ (1) $aA^2t^2+(2aAB+bA)t+aB^2+bB+c=0$，
$\Delta_1=A^2(b^2-4ac)$. \\
(2) $ (aA^2+bAD+cD^2)t^2+[2aAB+b(AE+BD)+2cDE]t+aB^2+bBE+cE^2=0 $，
\begin{gather}\label{二次方程分式线性变换}
    \Delta_2=(AE-BD)^2(b^2-4ac)
\end{gather}
