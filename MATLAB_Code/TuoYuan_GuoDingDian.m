...
hold on
fimplicit(@(x,y)x.^2/a2/((a2-b2)/(a2+b2))^2+y.^2/b2/((a2-b2)/(a2+b2))^2-1,'k','linewidth',0.8)
...
fimplicit(@(x,y)x*x0/a2+y*y0/b2-1,'k','linewidth',0.8)
fimplicit(@(x,y)a2*y0*(x-x0)-b2*x0*(y-y0),'k','linewidth',0.8)
axis equal
